...
namespace Ejercicio1_TP1_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            //Solicitar al usuario que ingrese la base y altura de un rectamgulo, y calcular y mostrar por pantalla el area y perimetro del mismo//
            float area;
            float basee;
            float perimetro;
            float altura;
